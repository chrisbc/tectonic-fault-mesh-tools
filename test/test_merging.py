...
from fault_mesh.utilities.merging import (
    align_two_nearly_adjacent_segments, densify_line,
    merge_multiple_nearly_adjacent_segments,
    merge_two_nearly_adjacent_segments, sorted_merge)
...
class test_merging(TestCase):
    ...
    def test_merge_two_nearly_adjacent_segments_with_tolerance(self):
        line1 = LineString([(0, 0), (200, 1)])
        line2 = LineString([(200, 0), (400, 0)])
        new_line = merge_two_nearly_adjacent_segments([line1, line2], tolerance=1.0)
        self.assertTrue(new_line.equals(LineString([(0, 0), (200, 0.5), (400, 0)])))
